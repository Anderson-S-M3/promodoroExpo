...
export default function FailedButton({ onPress }: IOnPress) {
  return (
    <View>
      ...
      4.7 12.3 0 17l-22.6 22.6c-4.7 4.7-12.3 4.7-17 0L256 295.6l-62.2
      ...
      12.3-4.7 17 0l62.2 62.2 62.2-62.2c4.7-4.7
      12.3-4.7 17 0l22.6 22.6c4.7 4.7 4.7 12.3 0 17z"
          />
        </Svg>
      </TouchableOpacity>
    </View>
