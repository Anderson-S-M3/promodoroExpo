...
export default function SucessButton({ onPress }: IOnPress) {
  return (
    <View>
      <TouchableOpacity style={styles.iconsContainer} onPress={onPress}>
        <Svg style={styles.icons} viewBox="0 0 512 512" width={48} height={48}>
          <Path
            fill="currentColor"
            d="M256 8C119.033 8 8 119.033 8 256s111.033 248 248 248 
          248-111.033 248-248S392.967 8 256 8zm0 48c110.532 0 200
          89.451 200 200 0 110.532-89.451 200-200 200-110.532 0-200-89.451-200-200
          ...
          4.705 12.265 4.736 16.97.068l172.589-171.204c4.704-4.668 4.734-12.266.067-16.971z"
          ></Path>
        </Svg>
      </TouchableOpacity>
    </View>
